...
const ModalAddDonors = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/controllers/developers/donors/donor.php?id=${itemEdit.donor_id}` // update records
          : `${apiVersion}/controllers/developers/donors/donor.php`, // create records
        itemEdit
